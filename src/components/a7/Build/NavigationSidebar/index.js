    ...
    return(
        <>
            <div id="navi" className="list-group">
                <Link to="/a7/" className="list-group-item" href="#">
                    <i className="fab fa-twitter"/></Link>
                <Link to="/a7/twitter/home" className={`list-group-item ${active==='home'?'active':''}`} href="#">
                ...
                <Link to="/a7/twitter/profile" className={`list-group-item ${active==='profile'?'active':''}`} href="#">
