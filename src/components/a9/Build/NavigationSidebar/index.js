    ...
    return(
        <>
            <div id="navi" className="list-group">
                <Link to="/a9/" className="list-group-item" href="#">
                    <i className="fab fa-twitter"/></Link>
                <Link to="/a9/twitter/home" className={`list-group-item ${active==='home'?'active':''}`} href="#">
                ...
                <Link to="/a9/twitter/profile" className={`list-group-item ${active==='profile'?'active':''}`} href="#">
